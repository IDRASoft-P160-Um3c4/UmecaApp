...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    String getCodedPassByUsername(@Param("usrname") String usrname);

    @Query("SELECT new com.umeca.model.shared.SelectList(u.id,u.fullname,u.password) FROM User u " +
            "WHERE u.username=:usrname")
    SelectList getIdAndFullnameByUsername(@Param("usrname") String usrname);
