...
public interface JobRepository extends JpaRepository<Job, Long> {
    ...
    @Query("select new com.umeca.model.entities.reviewer.dto.JobDto(J.id, J.company,J.post,J.nameHead,J.salaryWeek, J.phone,J.start,J.end,E.id,J.reasonChange) from Job J " +
