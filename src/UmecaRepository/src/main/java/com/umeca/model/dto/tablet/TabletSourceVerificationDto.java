...
public class TabletSourceVerificationDto {
    ...
    public TabletSourceVerificationDto(Long id, String fullName, String age, String address, String phone, Boolean isAuthorized, Date dateComplete, Date dateAuthorized, String specification, Boolean visible,
