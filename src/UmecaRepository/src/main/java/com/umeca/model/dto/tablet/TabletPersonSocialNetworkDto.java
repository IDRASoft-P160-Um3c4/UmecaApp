...
public class TabletPersonSocialNetworkDto {
    ...
    public TabletPersonSocialNetworkDto(Long id, String name, String age, String phone, String address, String specification, Boolean isAccompaniment, String specificationRelationship, Boolean block) {
        this.id = id;
        this.webId = id;
        this.name = name;
        this.age = age;
