...
public class TabletJobDto {
    ...
    public TabletJobDto(Long id, String post, String nameHead, String company, String phone, Date startPrev, Date start, String salaryWeek, Date end, String reasonChange, String address, Boolean block,
