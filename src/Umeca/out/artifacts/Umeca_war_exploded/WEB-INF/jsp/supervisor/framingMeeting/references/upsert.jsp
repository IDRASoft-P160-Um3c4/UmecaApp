                    ...
                    <form id="FormReferencesId" name="FormReferencesId" class="form-horizontal" role="form">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="row">
                                            <div class="col-xs-12 element-center">
                                                <label>&iquest;El imputado cuenta con alguna referencia
                                                    personal?</label>
                                                <br/>
                      <span class="field-validation-valid" data-valmsg-for="hasVictimWitnessInfo"
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input name="hasVictimWitnessInfo" class="ace" type="radio"
                                                               ...
                                                               ng-checked="refe.hasVictimWitnessInfo==true"
                                                               data-val="true"
                                                    ...
                                                    <label>
                                                        <input name="hasVictimWitnessInfo" class="ace" type="radio"
                                                               ng-value="false"
                                                               ng-model="refe.hasVictimWitnessInfo"
                                                               ng-checked="refe.hasVictimWitnessInfo==false"
                                                               data-val="true"
                                                               data-val-required="Debe seleccionar un valor"
                                                               ng-change="existHousemate(refe.hasVictimWitnessInfo);">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <label>Relaci&oacute;n con el
                                                            imputado:</label>&nbsp;&nbsp;<label class="info-example">(En
                                                        caso de no tener relaci&oacute;n explique por cu&aacute;nto
                                                        tiempo lo conoce)</label>
                                                        <br/>
                                                    ...
                                                    <div class="col-xs-6" ng-show="refe.relationship.id==8">
                                                        ...
                                                        <br/>
                                                        <input id="timeAgo" ng-model="refe.timeAgo" name="timeAgo"
                                                               type="text"
                                                               class="input-xxlarge" data-val="true"
                        ...
                        <div class="widget-box" ng-show="refe.isAccompaniment==true">
                            <div class="widget-header">Datos adicionales&nbsp;&nbsp;<label class="info-example">(Corroborar
                                que los datos
                                proporcionados
