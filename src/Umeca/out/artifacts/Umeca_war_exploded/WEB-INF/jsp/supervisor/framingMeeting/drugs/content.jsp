...
<div class="row">
    ...
    <input type="hidden" ng-update-hidden ng-model="blockD" name="block" id="block"
           ng-init='blockD = "${d.block}"'>
...
<div class="row" ng-show="d.type.specification==true">
    ...
    <div class="col-xs-4" ng-show="d.type.specification==true">
        <input class="form-control" data-val="true"
               data-val-length="Debe tener al menos 3 y m&aacute;ximo 100 caracteres" ng-readonly="!blockD"
               data-val-length-max="100" data-val-length-min="3"
               data-val-required="La especificaci&oacute;n es un campo requerido"
               type="text" value="" ng-model="d.other"
               ng-init='d.other = "${(d.specificationType == null) ? '' : d.specificationType}"' id="specificationType"
    ...
    <div class="col-xs-4" ng-show="d.per.specification==true">
        <input class="form-control" data-val="true"
               ...
               ng-init='d.specificationPeriodicity = "${(d.specificationPeriodicity == null) ? '' : d.specificationPeriodicity}"'
...
<div class="row">
    ...
    <div class="col-xs-4">
        <input class="form-control" data-val="true"
               data-val-length="Debe tener al menos 2 y m&aacute;ximo 25 caracteres"
               data-val-length-max="25" data-val-length-min="2" data-val-required="La cantidad es un campo requerido"
               ng-readonly="!blockD"
               type="text" ng-model="d.quantity" ng-init='d.quantity="${(d.quantity == null) ? '' : d.quantity}";'
...
<div class="row">
    ...
    <div class="col-xs-4">
        <input class="form-control" data-val="true"
               data-val-length="Debe tener al menos 2 y m&aacute;ximo 25 caracteres"
               data-val-length-max="25" data-val-length-min="2" data-val-required="Edad de inicio es un campo requerido"
               ng-readonly="!blockD"
               type="text" ng-model="d.onsetAge" ng-init='d.onsetAge="${(d.onsetAge== null) ? '' : d.onsetAge}";'
               name="onsetAge" id="onsetAge">
        <br/>
