<div id="notifications-tab" class="tab-pane active" ng-init ='lstNotification = ${lstNotification}; lstNotificationA= ${lstNotificationA};'>
    <div class="clearfix">
        <div class="comments">
                ...
                <div class="body">
                    ...
                    <div class="text" ng-show="n.action!= 'INFORMATION'">
                        ...
                        <span class="lbl"><strong>{{n.typeName}}</strong></span>
                            ...
                            <span>
                            Capeta Judicial: <strong>{{n.mpId}}</strong> Imputado: <strong>{{n.personName}}</strong> <br/></span>
