            ...
            <div class="modal-content">
                                    ...
                                    <div class="panel-body">
                                        <div class="row" style="position: relative;">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 text-danger element center"
                                                         ng-show="comments&&authorize!=undefined">
                                                        <label><b><i
                                                                class="icon-warning-sign icon-animated-wrench bigger-120"></i>&nbsp;
                                                            Si cierra la minuta se cerraran todos los acuerdos
                                                            registrados.</b></label>
                                                    </div>
                                                    <div class="col-xs-12"
                                                         ng-show="comments&&authorize!=undefined">
                ...
                <div class="modal-footer" ng-show="responseSaved==false">
                    ...
                    <span class="btn btn-default btn-primary btn-sm" id="btn-def-ck" ng-disabled="WaitFor==true"
                          ng-click="submitResponse('#FormRespId','<c:url value="/shared/minute/doAuthRejFinishRequest.json"/>');">
                          Guardar
                    </span>
                </div>
