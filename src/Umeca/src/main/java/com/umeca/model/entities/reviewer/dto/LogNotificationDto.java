...
public class LogNotificationDto {
    ...
    public LogNotificationDto(String idFolder, String imputedName, String status, Date orderDate) {
        ...
        if(status.equals(Constants.S_MEETING_INCOMPLETE)) {
            ...
            message="Debe completar la entrevista de riesgos procesales del caso con carpeta de investigaci�n "+this.idFolder+" para el imputado "+this.imputedName+".";
        }
        else
        if(status.equals(Constants.S_MEETING_INCOMPLETE_LEGAL)) {
            title="Informaci�n legal incompleta.";
            message="Debe completar la informaci�n legal de la entrevista de riesgos procesales del caso con carpeta de investigaci�n "+this.idFolder+" para el imputado "+this.imputedName+".";
        }
        else
        if(status.equals(Constants.VERIFICATION_STATUS_AUTHORIZED)) {
            title="Autorizaci�n de fuentes terminada.";
            message="Ha finalizado autorizaci�n de fuentes para el caso con carpeta de investigaci�n "+this.idFolder+" para el imputado "+this.imputedName+".";
        }
        else
        if(status.equals(Constants.VERIFICATION_STATUS_NEW_SOURCE)) {
            title="Autorización de fuentes.";
            message="Se ha completado el registro de datos legales. Debe autorizar las fuentes para el caso con carpeta de investigaci�n "+this.idFolder+" para el imputado "+this.imputedName+".";
        }
        else
        if(status.equals("NO_SOURCES")) {
            title="Fuentes no disponibles.";
            message="Debe agregar fuentes para realizar la verificaci�n de la entrevista de riesgos procesales del caso con carpeta de investigaci�n "+this.idFolder+" para el imputado "+this.imputedName+".";
        }
        else
        if(status.equals("SOURCES_NO_MEETING")) {
            title="Fuentes disponibles.";
            message="Debe realizar las entrevistas a las fuentes para la entrevista de riesgos procesales del caso con carpeta de investigaci�n "+this.idFolder+" para el imputado "+this.imputedName+".";
        }
