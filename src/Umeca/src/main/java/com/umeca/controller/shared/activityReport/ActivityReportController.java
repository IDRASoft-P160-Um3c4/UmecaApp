package com.umeca.controller.shared.activityReport;
...
public class ActivityReportController {
    ...
    @RequestMapping(value = "/shared/activityReport/index", method = RequestMethod.GET)
    public String index() {
    ...
    @RequestMapping(value = {"/shared/activityReport/list"}, method = RequestMethod.POST)
    public
    @ResponseBody
