app.controller('trainingController', function ($scope, $timeout, $sce, $http) {
        ...
        $scope.chkFields = function () {
            if ($scope.training.name != undefined && $scope.training.name != "" &&
                $scope.training.place != undefined && $scope.training.place != "" &&
                $scope.training.duration != undefined && $scope.training.duration != "" &&
                $scope.training.start != undefined && $scope.training.start != "" &&
                $scope.training.end != undefined && $scope.training.end != "")
                return true;
