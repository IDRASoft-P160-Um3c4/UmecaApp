...
<div class="row">
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-10">
            <input class="width-100" data-val="true" data-val-length="Debe tener al menos 3 y m&aacute;ximo 150 caracteres" ng-readonly="!blockR"
...
<div class="row">
    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <textarea class="form-control" data-val="true" data-val-length="Debe tener al menos 5 y m&aacute;ximo 200 caracteres"  ng-readonly="!blockR"
    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <input class="form-control" data-val="true" data-val-length="Debe tener al menos 1 y m&aacute;ximo 255 caracteres"
                   ...
                   type="text" value="${r.specificationRelationship}" ng-model="r.specificationRelationship" ng-init='r.specificationRelationship="${(r.specificationRelationship == null) ? '':r.specification}"' id="specificationRelationship" name="specificationRelationship">
        </div>
        <div class="col-xs-9 col-xs-offset-3">
    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <input class="form-control" data-val="true" data-val-length="Debe tener al menos 1y m&aacute;ximo 2 caracteres"
                   data-val-length-max="2" data-val-length-min="1" data-val-required="La edad es un campo requerido"  ng-readonly="!blockR"
