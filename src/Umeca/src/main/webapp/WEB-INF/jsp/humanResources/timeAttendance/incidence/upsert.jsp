...
<div>
  <div id="dlgUpModalId" class="modal fade" ng-controller="upsertController" ng-cloak>
    <div class="modal-dialog" style="width:500px" ng-controller="upsertIncidenceController" ng-init='init(${Incidence});'>
      <div class="modal-content">
        <div class="modal-header">
          <div class="alert alert-info ">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="element-center"><i class="glyphicon glyphicon-comment "></i>&nbsp;&nbsp;Justificar incidencia</h4>
          </div>
        </div>
        ...
        <div class="modal-footer">
                    ...
                    <span class="btn btn-default btn-primary btn-sm" ng-disabled="WaitFor==true"
                          ng-click="submitAbsence('#FormCatId','<c:url value="/humanResources/incidence/doUpsertIncidence.json"/>');">
                          Aceptar
                    </span>
        </div>
      </div>
