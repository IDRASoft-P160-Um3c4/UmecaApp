...
<script>
    $(document).ready(function () {
                ...
                if (type == 0) {
                    gridUrl = '<c:url value="/humanResources/digitalRecord/listSchoolCourses.json?id="/>' +${idEmployee};
                } else if (type == 1) {
                    gridUrl = '<c:url value="/humanResources/digitalRecord/listTraining.json?id="/>' +${idEmployee};
                }
