...
<script>
    ...
    $(function () {
        'use strict';
        var url = '<c:url value='/humanResources/document/doUpsertAttachment.json'/>';
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="alert alert-info ">
                        ...
                        <h4 class="element-center"><i class="icon-file"></i>&nbsp;&nbsp;Agregar archivo a oficio</h4>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="widget-box">
                                    <div class="widget-header">Agregar archivo a oficio</div>
