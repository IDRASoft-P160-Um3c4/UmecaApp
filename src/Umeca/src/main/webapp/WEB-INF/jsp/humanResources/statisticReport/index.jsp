              ...
              <div class="col-xs-10 col-xs-offset-1">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6" ng-disabled=true
                       ng-show="idReportType == 2">
                    <input type="hidden" ng-update-hidden ng-model="idDistrict" name="idDistrict"
                           id="idDistrict" ng-disabled="idReportType == 1">
                    ...
                    <select id="district"
                            ...
                            ng-disabled="idReportType == 1 || idReportType == 3">
                    </select>
                  </div>

                  <div class="col-xs-6" ng-disabled=true
                       ng-show="idReportType == 3">
                    <input type="hidden" ng-update-hidden ng-model="idEmployee" name="idEmployee"
                           id="idEmployee" ng-disabled="idReportType == 1">
