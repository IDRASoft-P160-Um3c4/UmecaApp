...
<h2 class="element-center"><i class="icon-archive"></i>&nbsp;&nbsp;Datos personales</h2>

<form id="EmployeeFormId" name="EmployeeFormId" class="form-horizontal"
      role="form" ng-controller="upsertController" method="post">
    <br/>


    <div class="container body-content" ng-controller="employeePersonalDataController"
              ...
              ng-click="returnUrlId('<c:url value='/supervisor/hearingFormat/indexFormats.html'/>'+'?id='+m.idCase)">
                ...
                <div ng-show="m.canSave==true">
                            ...
                            <span class="btn btn-default btn-primary btn-sm" ng-disabled="WaitFor==true"
                                  ng-click="submitPartiaSaveHF('#EmployeeFormId','<c:url value='/supervisor/hearingFormat/doUpsert.json'/>');">
                                                  Guardar
                                            </span>
                </div>
            </div>
        ...
        <div class="row">
            <div id="finishConfirm" class="modal-footer" ng-show="m.canSave==true">
                    <span class="btn btn-default btn-primary btn-sm" ng-disabled="WaitFor==true" ng-confirm-action
                          ...
                          confirmed-click-action="saveHF('#EmployeeFormId','<c:url value='/supervisor/hearingFormat/doUpsert.json'/>',validateSave);">
                          Terminar
                    </span>
            </div>
        </div>
