...
<div>
    <div id="dlgUpModalId" class="modal fade" ng-controller="upsertController" ng-cloak>
        <div class="modal-dialog" style="width:500px" ng-controller="upsertDeviceController" ng-init='init(${device}); lstDeviceUse = ${lstDeviceUse}; initCatalog();'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <select class="form-control element-center"
                                        ng-model="DeviceUses"
                                        ng-options="e.name for e in lstDeviceUse"></select>
                                <input type="hidden" name="deviceUse" value="{{DeviceUses.id}}"/>
                            </div>
                        </div>
                        <br/>
