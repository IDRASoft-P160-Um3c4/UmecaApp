                ...
                jQuery("#GridId").jqGrid({
                    ...
                    gridComplete: function () {
                        ...
                        for (var i = 0; i < ids.length; i++) {
                            ...
                            be += "&nbsp;<a href=\"javascript:;\" style=\"display:inline-block;\" title=\"Bit�cora de supervisi&oacute;n\" onclick=\"window.supervisionLog('" + cl + "');\"><span class=\"glyphicon glyphicon-eye-open\"></span></a>";
