            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div  ng-class="(isAuthorized ? 'alert alert-info' : 'alert alert-warning')">
                        ...
                        <h4 class="element-center" ng-show="isAuthorized"><i class="glyphicon glyphicon-saved"></i>&nbsp;&nbsp;Autorizar</h4>
                        <h4 class="element-center" ng-show="!isAuthorized"><i class="glyphicon glyphicon-remove"></i>&nbsp;&nbsp;Rechazar</h4>
                    </div>
                </div>
                    ...
                    <form id="FormCatId" name="FormCatId" ng-submit="submit('#FormCatId')" class="form-horizontal"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div ng-class="(isAuthorized ? 'panel panel-primary' : 'panel panel-warning')">
                                    <div class="panel-heading">
                                        <span class="glyphicon glyphicon-map-marker"></span>&nbsp;&nbsp;Observaciones sobre el plan de seguimiento
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                ...
                <div class="modal-footer" id="btn-act-footer">
                    <button class="btn btn-default btn-sm" ng-click="cancel()">Cancelar</button>
                        <button class="btn btn-default btn-primary btn-sm" ng-show = "m.password && m.comments"
                              ng-click="submit('#FormCatId', '<c:url value='/supervisorManager/authorizeMonitoringPlan/doAuthorizeRejectMonPlan.json' />')">
                              Aceptar
                        </button>
                </div>
            </div>
