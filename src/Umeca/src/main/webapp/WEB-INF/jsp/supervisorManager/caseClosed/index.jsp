    ...
    <script>
        ...
        $(document).ready(function () {
            jQuery("#GridId").jqGrid({
                ...
                datatype: "json",
                mtype: 'POST',
                colNames: ['ID', 'idStatus', 'Carpeta Judicial', 'Nombre completo', 'Fecha de nacimiento', 'Sustra&iacute;do','Estatus', 'Acci&oacute;n'],
                colModel: [
                    ...
                    { name: 'substractedStr', index: 'substractedStr', width: 160, align: "center", sorttype: 'string', search: false },
