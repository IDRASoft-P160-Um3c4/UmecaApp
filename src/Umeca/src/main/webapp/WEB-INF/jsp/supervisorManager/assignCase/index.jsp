    ...
    <script>
        ...
        $(function () {
            ...
            $("#GridId").jqGrid({
                ...
                datatype: "json",
                mtype: 'POST',
                colNames: ['ID', 'preassignedId', 'Carpeta de Investigaci&oacute;n', 'Nombre completo', 'Estado', 'Asignado a', 'Acci&oacute;n'],
                colModel: [
                    {name: 'id', hidden: true},
                    {name: 'preassignedId', hidden: true},
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default btn-secondary" ng-click="cancel()">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
        <div id="MessageBoxDialog" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-{{Type}}" ng-click="MsgBoxOK()">Aceptar
                        </button>
                    </div>
                </div>
            </div>
