...
<link href="${pageContext.request.contextPath}/assets/content/themes/umeca/font-awesome.min.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/assets/content/themes/umeca/ace-fonts.css" rel="stylesheet" type="text/css">

<link href="${pageContext.request.contextPath}/assets/content/themes/umeca/ace.min.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/assets/content/themes/umeca/ace-rtl.min.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/assets/content/themes/umeca/ace-skins.min.css" rel="stylesheet" type="text/css">
