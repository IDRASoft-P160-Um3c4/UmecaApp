                ...
                <ul class="nav ace-nav">
                    ...
                    <sec:authorize access="hasRole('ROLE_HUMAN_RESOURCES')">
                        <li class="dropdown nav-li-blue">
                            ...
                            <ul class="dropdown-menu">
                                <li><a
                                        href="<c:url value='/assets/applications/TimeAttendanceApp/TimeAttendanceApp.application'/>"><i
                                        class="glyphicon glyphicon-cloud-download"></i>&nbsp;&nbsp;Ejecutar...</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <sec:authorize access="hasRole('ROLE_DETENTION_RECORD_MANAGER')">
                        ...
                        <li class="nav-li-blue"><a href="<c:url value='/detentionRecordManager/detainedSheet.html'/>"><i
                                class="glyphicon glyphicon-transfer"></i>&nbsp;&nbsp;S&aacute;bana de detenidos</a>
                        </li>
                    </sec:authorize>
