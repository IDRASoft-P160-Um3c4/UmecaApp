            ...
            <ul class="nav navbar-nav">
                ...
                <sec:authorize access="hasRole('ROLE_SUPERVISOR')">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<c:url value='/supervisor/hearingFormat.html' />"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;Formato de audiencia</a></li>
                            <li><a href="<c:url value='/supervisor/generateMonitoringPlan/index.html' />"><i class="glyphicon glyphicon-folder-open"></i>&nbsp;&nbsp;Generar/Modificar plan de supervisión</a></li>
