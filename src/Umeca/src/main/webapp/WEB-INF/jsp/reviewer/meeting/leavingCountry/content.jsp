    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="col-xs-9 element-left">
                    ...
                    �El detenido cuenta con documentaci�n oficial que facilite que abandone el pa�s?:
                </div>
                <div class="col-xs-3">
        ...
        <div>
            <div class="row">
                <div class="col-xs-12">
                    <div class="col-xs-9 element-left">
                        ...
                        �El detenido ha vivido en otro pa�s?:
                    </div>
                    <div class="col-xs-3">
            ...
            <div class="row" ng-show="l.ocId ==1">
                ...
                <div class="col-xs-2 element-right">
                    Motivo por el que ahora vive en M�xico:
                </div>
                <div class="col-xs-4">
    ...
    <div>
        <div class="row">
            ...
            <div class="col-xs-9 element-left">
                ...
                �El detenido cuenta con familiares y/o amigos cercanos en otro pa�s?:
            </div>
            <div class="col-xs-3">
        ...
        <div class="row" ng-show="l.facId ==1">
            ...
            <div class="col-xs-4 element-left">
                �Mantiene comunicaci�n con ellos?:
            </div>
            <div class="col-xs-2">
