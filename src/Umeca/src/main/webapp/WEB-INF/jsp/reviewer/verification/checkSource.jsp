...
<head>
    ...
    <script>
        ...
        function checkSource(){
            window.showUpsert(id,id, "/reviewer/verification/checkSource.html");
        }
        ...
        function verification(i){
            ...
            window.showUpsert(id,id, "/reviewer/verification/detailVerification.html");
        }
    </script>
            ...
            <div class="tabbable tabs-left">
                ...
                <div class="tab-content">
                    <div id="personalData" class="tab-pane in active">
                        <%@ include file="/WEB-INF/jsp/reviewer/personal/index.jsp"%>
                    </div>
