<div ng-controller="socialNetworkController">
    <div class="row">
        <div>
            ...
            <span ng-class="lstSourceInfoSocial['socialNetwork.comment']==true?'verified':'';">
                ...
                <span ng-class="lstFinalInfoSocial['socialNetwork.comment']==true?'verified':'';">
                <i class="purple icon-list icon-only bigger-120" ng-show="selectSource"
                   onclick="window.showChoices('socialNetwork.comment')"></i>
            </span>
                Observaciones:
                            ...
                            <div class="row" ng-show="readOnly == false">
                                ...
                                <div class="col-xs-10 col-xs-offset-1 text-info" style="padding-top: 8px;">
                                    <i class="purple glyphicon glyphicon-user bigger-160"
                                       ng-click="showChoicesSection(3,p.id,1,'Red social, persona',$index+1)"
