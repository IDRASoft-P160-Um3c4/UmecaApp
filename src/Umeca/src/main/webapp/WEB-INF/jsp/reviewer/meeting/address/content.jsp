<div class="row">
    ...
    <div class="col-xs-2 element-right">
        ...
        <a class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-list-alt orange"
                                                                           style="display: none;"></i> </a>
            <ul class="dropdown-menu">
                <li>
                    <label for="r1"><input type="radio" name="radiocp" id="r1" onclick="checkSource()"> &nbsp;Jos�
                        Ramierez</label><br/>
                ...
                <li>
                    <label for="r2"><input type="radio" name="radiocp" id="r2" onclick="checkSource()"> &nbsp;Carlos
                        G�mez</label><br/>
    ...
    <div class="col-xs-3">
        <input type="hidden" id="urlRequest" ng-model="url">
        <input type="text" id="zipCode" class="form" zip-search ng-model="zipCode"
               ng-init='zipCode = "${(zipCode == null) ? "" : zipCode}"'
               data-val="true" data-val-required="El c�digo postal es un campo requerido" name="zipCode"
...
<div class="row">
    ...
    <div class="col-xs-4">
        <input class="form-control" data-val="true" data-val-required="La calle es un campo requerido"
               ...
               type="text" value="" ng-model="d.street" name="street" id="street"
               ng-init='d.street = "${(d.street == null) ? "" : d.street}"'>
...
<div class="row">
    ...
    <div class="col-xs-3">
        <input class="form-control" data-val="true" data-val-length="Debe tener al menos 1 y m�ximo 10 caracteres"
               ...
               type="text" ng-init='a.noOut = "${(d.noOut == null) ? "" : d.noOut}"' ng-model="a.noOut" id="noOut"
               name="noOut">
    ...
    <div class="col-xs-4">
        <input class="form-control" data-val="true" data-val-length="Debe tener al menos 1 y m�ximo 10 caracteres"
               data-val-length-max="10" data-val-length-min="1" ng-init='a.noIn = "${(d.noIn == null) ? "" : d.noIn}"'
               id="noIn" name="noIn"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-7">
                                    <input class="form-control" data-val="true"
                                           data-val-length="Debe tener al menos 1 y m�ximo 30 caracteres"
                            ...
                            <div class="row element-left">
                                ...
                                <div class="col-xs-9">
                                    <textarea id="reasonChange" name="reasonChange" ng-model="a.reasonChange"
                                              ...
                                              class="form-control"
                                              data-val="true"
                                              data-val-length="Debe tener al menos 1 y m�ximo 500 caracteres"
                                              data-val-length-max="500" data-val-length-min="1"
                                              data-val-required="La raz�n de cambio es un campo requerido"></textarea>
                                    <br/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9">
                                    <textarea id="description" class="form-control" name="description"
                                              ...
                                              data-val-length="Debe tener al menos 1 y m�ximo 500 caracteres"
                                              data-val-length-max="500" data-val-length-min="1"
                                              data-val-required="La descripci�n es un campo requerido"></textarea>
                                    <br/>
