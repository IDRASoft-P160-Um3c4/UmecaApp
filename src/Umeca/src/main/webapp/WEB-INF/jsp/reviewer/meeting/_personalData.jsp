    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-9">
            <input class="form-control" data-val="true"
                   data-val-length="Debe tener 10 caracteres" ng-init="celPhone=${m.imputed.celPhone}"
                   data-val-length-max="10" data-val-length-min="10"
                   id="celPhone" name="imputed.celPhone"
        ...
        <div class="widget-box">
            ...
            <div class="widget-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <input type="text" class="form-contro1" name="imputed.dependentBoys" value="${m.imputed.dependentBoys}"/>
                    </div>
                                    </div>
                </div>
                <br/>
    ...
    <div class="col-xs-9">
            <div class="widget-main">
                <select multiple="" class="width-90 chosen-select" ng-model="phyModel" data-placeholder="..."
                        ng-init='lstPhysicalCondition = ${lstPhysicalCondition}; pCSelected = ${physicalCondition}; selectedPhysicalCondition(lstPhysicalCondition,pCSelected);'
    ...
    <div class="col-xs-9">
        <div class="widget-main">
            <select multiple="" class="width-90 chosen-select" ng-model="activityModel" data-placeholder="..."
                    ng-init='lstActivity = ${lstActivity}; activityList = ${activity}; selectedActivities(lstActivity,activityList);' name="activity" id="slctActivity"
