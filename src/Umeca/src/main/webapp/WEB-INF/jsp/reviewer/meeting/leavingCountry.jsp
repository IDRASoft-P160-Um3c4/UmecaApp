            ...
            <div class="row">
                ...
                <div class="row" ng-show="l.ocId ==1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <input class="form-control" data-val="true"
                                   data-val-length="Debe tener al menos 3 y máximo 100 caracteres"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <input class="form-control" data-val="true"
                                   data-val-length="Debe tener al menos 3 y máximo 25 caracteres"
                        ...
                        <div class="col-xs-4">
                            <textarea id="leaveCountry.reason" class="form-control" data-val="true"
                                      data-val-length="Debe tener al menos 3 y máximo 500 caracteres"
                                      data-val-length-max="500" data-val-length-min="3"
                                      data-val-required="La razón es un campo requerido" ng-model="l.reason"
