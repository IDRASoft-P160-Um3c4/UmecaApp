<div ng-controller="schoolController">
    ...
    <div class="row">
            ...
            <div class="col-xs-4">
                <select class="form-control element-center" ng-model="school.level" ng-disabled="!block"
            ...
            <div class="col-xs-4">
                ...
                <select class="form-control element-center" ng-model="school.degree"
                        ng-options="e.name for e in lstDegree" ng-disabled="!block"
                        ng-change="school.degreeId = school.degree.id"
                        ng-init='lstDegree = school.level.degrees;'></select>
                <input type="hidden" ng-update-hidden ng-model=" school.degree.id" name="school.degree.id" id="degreeId"
    ...
    <div class="row" ng-show="school.levelId == 7">
        <br/>
            ...
            <div class="col-xs-4">
                <input class="form-control" data-val="true" ng-readonly="!block"
    ...
    <div class="row">
            ...
            <div class="col-xs-9">
                <textarea class="width-100"    ng-model = "commentSchool" ng-init='commentSchool = "${m.commentSchool == null ? '' : m.commentSchool}";'
                          data-val="true"
