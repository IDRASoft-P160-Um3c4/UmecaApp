...
<div class="container body-content">
                ...
                gridComplete: function () {
                   ...
                   var status = $(this).jqGrid('getCol', 'status', false);
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        switch (status[i]){
                            case "VERIF":
                            be = "<a style=\"display:inline-block;\" title=\"Agregar opini�n t�cnica\" href=\"/reviewer/technicalReview/technicalReview.html?id=" + cl + "\"><span class=\"glyphicon glyphicon-plus\"></span></a>";
                            break;
                            case "TEC_REV":
                                be = "<a style=\"display:inline-block;\" title=\"Visualizar opini�n t�cnica\" href=\"/reviewer/technicalReview/technicalReview.html?id=" + cl + "\"><span class=\"glyphicon glyphicon-eye-open\"></span></a>";
                            break;
                            default:
    ...
    <h2 class="element-center"><i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;Opini�n T�cnica</h2>
