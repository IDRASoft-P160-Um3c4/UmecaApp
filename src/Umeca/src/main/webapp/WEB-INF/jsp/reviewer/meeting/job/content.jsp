...
<div class="row">
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <input class="form-control" data-val="true"
                   ...
                   ng-readonly="!blockJ"
                   type="text" value="" ng-init='j.post= "${(j.post == null) ? "" : j.post}"' ng-model="j.post"
                   name="post" id="post">
        </div>
    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-6">
            <input class="form-control" data-val="true"
                   data-val-length="Debe tener al menos 5 y m&aacute;ximo 20 caracteres" ng-readonly="!blockJ"
                   data-val-length-max="20" data-val-length-min="5"
                   data-val-required="El tel&eacute;fono es un campo requerido"
                   type="text" value="" ng-model="j.phone" ng-init='j.phone = "${(j.phone == null)? "": j.phone}"'
                   name="phone" id="phone">
        </div>
        <div class="col-xs-9 col-xs-offset-3">
...
<div class="row">
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <input class="form-control" data-val="true"
                   data-val-length="Debe tener al menos 6 y m&aacute;ximo 150 caracteres" ng-readonly="!blockJ"
                   data-val-length-max="150" data-val-length-min="6"
                   data-val-required="El nombre del patr&oacute;n es un campo requerido"
                   type="text" value="" ng-model="j.nameHead"
                   ng-init='j.nameHead= "${(j.nameHead == null) ? "" : j.nameHead}"' name="nameHead" id="nameHead">
        </div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="col-xs-10">
            <textarea class="form-control" ng-init='j.address = "${(j.address == null) ? "" : j.address}"'
                      ng-model="j.address" name="address" id="address"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            <textarea id="form-field-11" class="form-control"
                                      ng-init='j.reasonChange = "${(j.reasonChange == null) ? "" : j.reasonChange}";'
                                      ng-model="j.reasonChange" name="reasonChange" ng-readonly="!blockJ"
                                      data-val="true"
