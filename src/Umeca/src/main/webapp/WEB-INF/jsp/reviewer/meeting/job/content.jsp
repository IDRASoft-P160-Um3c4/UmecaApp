    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-10">
            <input class="form-control" data-val="true" data-val-length="Debe tener al menos 3 y m&aacute;ximo 150 caracteres"
                   data-val-length-max="150" data-val-length-min="3" data-val-required="La empresa es un campo requerido" ng-readonly="!blockJ"
...
<div class="row">
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <input class="form-control" data-val="true" data-val-length="Debe tener al menos 3 y m&aacute;ximo 50 caracteres"
                   data-val-length-max="50" data-val-length-min="3" data-val-required="El puesto es un campo requerido" ng-readonly="!blockJ"
    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-6">
            <input class="form-control" data-val="true" data-val-length="Debe tener al menos 5 y m&aacute;ximo 20 caracteres" ng-readonly="!blockJ"
                   data-val-length-max="20" data-val-length-min="5" data-val-required="El tel&eacute;fono es un campo requerido"
...
<div class="row">
    <div class="col-xs-6">
        ...
        <div class="col-xs-8">
            <input class="form-control" data-val="true" data-val-length="Debe tener al menos 6 y m&aacute;ximo 150 caracteres"            ng-readonly="!blockJ"
    ...
    <div class="col-xs-6">
        ...
        <div class="col-xs-6">
            ...
            <select class="form-control element-center" ng-model="j.registerType"                          ng-readonly="!blockJ"
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-10">
           <textarea class="form-control" ng-init='j.address = "${(j.address == null) ? "" : j.address}"' ng-model="j.address" name="address" id="address"
                     ...
                     data-val-length="Debe tener al menos 6 y m&aacute;ximo 500 caracteres"   ng-readonly="!blockJ"
            ...
            <div class="row">
                <div class="col-xs-10 col-xs-offset-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-9">
                            <textarea id="form-field-11" class="form-control" ng-init='j.reasonChange = "${(j.reasonChange == null) ? "" : j.reasonChange}";' ng-model ="j.reasonChange" name ="reasonChange" ng-readonly="!blockJ"
