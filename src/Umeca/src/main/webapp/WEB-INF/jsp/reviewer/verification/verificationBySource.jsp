...
<div class="container body-content" ng-cloak>
    <div ng-controller="verificationController"
        ...
        <input type="hidden" ng-init="urlVerifTrue= '<c:url value="/reviewer/verification/verifBySourceEqual.json"/>'"
               ...
               ng-update-hidden>
        <input type="hidden"
               ng-init="urlVerifNotKnow= '<c:url value="/reviewer/verification/verifBySourceNotKnow.json"/>'"
               ng-model="urlVerifTrue"
               ng-update-hidden>
        <br/>
        ...
        <h2 class="element-center" ng-show="managereval==true"><i class="glyphicon icon-comments-alt">&nbsp;&nbsp;Entrevista
            de
