...
<input type="hidden" ng-init="urlVerifTrue= '<c:url value="/reviewer/verification/verifBySourceEqual.json"/>'"
       ...
       ng-update-hidden>
<input type="hidden" ng-init="urlVerifNotKnow= '<c:url value="/reviewer/verification/verifBySourceNotKnow.json"/>'"
       ng-model="urlVerifTrue"
       ng-update-hidden>
<br/>

<h2 class="element-center" ng-init="managereval = ${managereval}" ng-show="managereval==false"><i
        class="glyphicon icon-edit"></i>&nbsp;&nbsp;Entrevista de verificaci&oacute;n</h2>

<h2 class="element-center" ng-show="managereval==true"><i class="glyphicon icon-comments-alt">&nbsp;&nbsp;Entrevista de
    riesgos procesales</i></h2>
