<div ng-controller="schoolController">
    ...
    <div class="row" ng-init='schLists = ${(listScheduleSchool == null) ? '[]': listScheduleSchool};'>
        <div class="col-xs-12">
            ...
            <span ng-class="lstSourceInfoSchool['school.name']==true?'verified':'';">
            ...
            <span ng-class="lstFinalInfoSchool['school.name']==true?'verified':'';">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="col-xs-2 element-left">
                <span ng-class="lstSourceInfoSchool['school.phone']==true?'verified':'';">
                <i class="icon-ok-circle green  icon-only bigger-120" ng-show="verification"
                ...
                <span ng-class="lstFinalInfoSchool['school.phone']==true?'verified':'';">
                <i class="purple icon-list icon-only bigger-120" ng-show="selectSource"
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="col-xs-2 element-left">
                <span ng-class="lstSourceInfoSchool['school.address']==true?'verified':'';">
                <i class="icon-ok-circle green  icon-only bigger-120" ng-show="verification"
                ...
                <span ng-class="lstFinalInfoSchool['school.address']==true?'verified':'';">
                <i class="purple icon-list icon-only bigger-120" ng-show="selectSource"
            ...
            <div class="widget-box">
                <div class="widget-header">
                    <div class="col-xs-10 element-left">
                        <span ng-class="lstSourceInfoSchool['school.degree.id']==true?'verified':'';">
                        <i class="icon-ok-circle green  icon-only bigger-120" ng-show="verification"
                        ...
                        <span ng-class="lstFinalInfoSchool['school.degree.id']==true?'verified':'';">
                        <i class="purple icon-list icon-only bigger-120" ng-show="selectSource"
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-8">
                                <input class="form-control" data-val="true"
                                       ...
                                       value=""
                                       ng-model="school.specification" id="school.specification"
                                       name="school.specification"
    ...
    <div class="row" ng-show="schLists.length > 0 ">
        <div class="col-xs-12"
            ...
            <div class="widget-header header-color-blue">
                <div class="row">
                    <h6> &nbsp;
                        <span ng-class="lstSourceInfoSchool['school.schedule']==true?'verified':'';">
                        <i class="icon-ok-circle green  icon-only bigger-120" ng-show="verification"
                        ...
                        <i class="icon-ban-circle gray icon-only bigger-120" ng-show="verification"
                           ng-click="doConfirmVerifNotKnow('school.schedule')"></i>
                            ...
                            <span ng-class="lstFinalInfoSchool['school.schedule']==true?'verified':'';">
