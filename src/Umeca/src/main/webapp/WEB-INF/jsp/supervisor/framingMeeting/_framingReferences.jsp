...
<script>
    ...
    $(document).ready(function() {
        ...
        jQuery("#GridIdRef").jqGrid('navGrid', '#GridPagerRef', {
        ...
        jQuery("#GridIdRef").jqGrid('filterToolbar', {
            stringResult: true,
...
<div class="row element-center">
    <div class="col-xs-12">
        <h2> <i class="purple icon-list bigger-100">&nbsp;</i>Referencias personales</h2>
        <br/>
        <div id="angJsjqGridIdRef" ng-controller="modalDlgController">
            <table id="GridIdRef" class="element-center" style="margin: auto"></table>
