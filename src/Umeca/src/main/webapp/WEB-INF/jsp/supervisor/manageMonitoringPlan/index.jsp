        ...
        <script>
            ...
            $(document).ready(function() {
                jQuery("#GridId").jqGrid({
                    url: '<c:url value='/supervisor/manageMonitoringPlan/listB.json' />',
                    autoencode:true,
                    datatype: "json",
                    mtype: 'POST',
                    ...
                    colModel: [
                        ...
                        { name: 'stCreationTime', index: 'stCreationTime', width: 130, align: "center", sortable: false, sorttype: 'string', searchoptions: { sopt: ['lk'] } },
                        { name: 'stGenerationTime', index: 'stGenerationTime', width: 130, align: "center", sortable: false, sorttype: 'string', searchoptions: { sopt: ['lk'] } },
                        { name: 'stAuthorizationTime', index: 'stAuthorizationTime', width: 140, align: "center", sortable: false, sorttype: 'string', searchoptions: { sopt: ['lk'] } },
