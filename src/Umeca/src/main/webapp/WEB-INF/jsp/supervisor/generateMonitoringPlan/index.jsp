    ...
    <script>
        ...
        window.preAuthorize = function (id) {
            window.showConfirmFull(id, "#angJsjqGridId", "<c:url value='/supervisor/generateMonitoringPlan/preAuthorize.json' />", "#GridId",
                    "Plan de supervisi&oacute;n", "&iquest;Est&aacute; seguro de que desea solicitar la autorizaci&oacute;n del plan de supervisi&oacute;n para este caso?", "warning");
        };
                ...
                gridComplete: function () {
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        if (isMonPlanSuspended === 'true') {
                            ...
                            if (status === "NUEVO") {
                                be += "&nbsp;&nbsp;<a href=\"javascript:;\" style=\"display:inline-block;\" title=\"Generar plan de supervisi&oacute;n\" onclick=\"window.generate('" + cl + "');\"><span class=\"glyphicon glyphicon-plus-sign\"></span></a>";
                            } else if (status === "EN PROCESO DE GENERAR") {
                                be += "&nbsp;&nbsp;<a href=\"javascript:;\" style=\"display:inline-block;\" title=\"Solicitar autorizaci&oacute;n del plan de supervisi&oacute;n\" onclick=\"window.preAuthorize('" + cl + "');\"><span class=\"glyphicon glyphicon-thumbs-up\"></span></a>";
                            }
                            ...
                            if (status === "EN PROCESO DE GENERAR" || status === "AUTORIZADO" || status === "RECHAZADO AUTORIZAR" || status === "EN SEGUIMIENTO" || status === "RECHAZADO TERMINAR") {
                                be += "&nbsp;&nbsp;<a href=\"javascript:;\" style=\"display:inline-block;\" title=\"Modificar plan de supervisi&oacute;n\" onclick=\"window.generate('" + cl + "');\"><span class=\"glyphicon glyphicon-pencil\"></span></a>";
                            }
                        }
