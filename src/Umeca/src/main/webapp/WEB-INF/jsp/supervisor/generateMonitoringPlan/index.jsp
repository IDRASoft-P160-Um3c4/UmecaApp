    ...
    <div class="container body-content">
        ...
        <script>
            ...
            window.preAuthorize = function(id){
                window.showConfirmFull(id, "#angJsjqGridId", "", "#GridId", "Plan de supervisión", "¿Está seguro de que desea solicitar la autorización del plan de seguimiento para este caso y formato de audiencia?", "warning");
            };
            ...
            $(document).ready(function() {
                jQuery("#GridId").jqGrid({
                    ...
                    datatype: "json",
                    mtype: 'POST',
                    colNames: ['ID', 'Formato de audiencia', 'Carpeta investigación', 'Carpeta judicial','Imputado', 'Fecha asignación', 'Estatus', 'Asignado a', 'Acción'],
                    colModel: [
                    ...
                    gridComplete: function () {
                        ...
                        for (var i = 0; i < ids.length; i++) {
                            ...
                            if (status === "NUEVO") {
                                ...
                                be += "&nbsp;&nbsp;<a href=\"javascript:;\" style=\"display:inline-block;\" title=\"Solicitar autorización del plan de supervisión\" onclick=\"window.preAuthorize('" + cl + "');\"><span class=\"glyphicon glyphicon glyphicon-thumbs-up\"></span></a>";
