    ...
    <script>
        ...
        $(document).ready(function () {
            jQuery("#GridCasesId").jqGrid({
                ...
                datatype: "json",
                mtype: 'POST',
                colNames: ['ID', 'idStatus', 'Carpeta de Investigación','Carpeta Judicial','Nombre completo', 'Estatus', 'Acción'],
                colModel: [
                    ...
                    { name: 'statusDesc', index: 'statusDesc', width: 250, align: "center", sorttype: 'string', searchoptions: { sopt: ['bw'] } },
